<script setup>
    ...
    import s1 from "./../data/master/RO/S1"
    import s2 from "./../data/master/RO/S2"
    ...
    // ----------------------------------------- Year Configuration --------------------------------
    const { program_s1, program_s2 } = Year(s1, s2)
...
<template>
    <div>
        <h5 class="special-heading px-2 text-center py-4 border shadow-sm mb-4 bg-light ">
