                ...
                <tbody v-for="unite in unites">
                    <tr v-for="(_module, index) in unite.modules">
                        ...
                        <td v-if="_module.hasTP">
                            <input :class="_module.tp.value > 20 && 'border-danger'" max="20" v-model="_module.tp.value"  type="number" placeholder="TP" class="form-control border-none">
                        </td>
                        <td :colspan="(_module.noTD && !_module.hasTP) ? 3 : 2">
                            <input :class="_module.examen.value > 20 && 'border-danger'" max="20" v-model="_module.examen.value" type="number" placeholder="Examen" class="form-control border-none">
                        </td>
                    </tr>
                </tbody>
            </table>
