                ...
                <tbody v-for="unite in unites">
                    <tr v-for="(_module, index) in unite.modules">
                        ...
                        <td v-if="!_module.noTD" :colspan="!_module.hasTP && 2">
                            <input max="20" min="0" :class="(_module.td.value > 20 || _module.td < 0) && 'border-danger'" v-model="_module.td.value"  type="number" placeholder="TD" class="form-control border-none">
                        </td>
                        <td v-if="_module.hasTP">
                            <input max="20" min="0" :class="(_module.tp.value > 20 || _module.tp < 0) && 'border-danger'" v-model="_module.tp.value"  type="number" placeholder="TP" class="form-control border-none">
                        </td>
